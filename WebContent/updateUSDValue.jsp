...
<body style="background-color: #E6F9E6;">
	...
	<div class="container">
		<div class="row"
			...
			<form action="./UpdateUSDValueSrv" method="post"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="username">Enter current INR to USD Exchange Rate:</label> 
						<input type="number" name="usd"  placeholder="Enter only numbers" class="form-control" id="usd" required />
					</div>
				</div>
