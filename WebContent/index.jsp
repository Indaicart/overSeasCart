	...
	<div class="container">
		<div class="product-flex-wrap">
			...
			for (ProductBean product : products) {
				int cartQty = cartService.getCartItemCount(userName, product.getProdId());
			%>
			<div class="product-card1">
				<a href="productDetails.jsp?pid=<%=product.getProdId()%>"> <img
				...
				%>
				<div class="productinfo1"><%=description%>..
				</div>
				<div class="prod-weight1"><%=product.getProdWeight()%>
					grams
				</div>
				<div class="price1">
					$
					<%=product.getProdPrice()%></div>
				<form method="post">
					<%
					if (cartQty == 0) {
					%>
